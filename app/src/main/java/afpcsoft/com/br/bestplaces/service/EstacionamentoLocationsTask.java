...
public class EstacionamentoLocationsTask extends AsyncTask<String, Void, LocalResult> {
    ...
    public EstacionamentoLocationsTask(Context context, OnPostExecuteListener onPostExecuteListener, double lat, double lng) {
...
//        gps = new GPSTracker(context);
    ...
    protected LocalResult doInBackground(String... params) {
        ...
        String url = "http://ec2-54-153-109-26.us-west-1.compute.amazonaws.com/estacionamento.php?lat="+lat+"&lng="+lng;

        System.out.println(url);
        LocalResult localResult = new LocalResult();
        List<Estacionamento> estacionamentoList = new ArrayList<Estacionamento>();
        ...
        try {
            ...
            Gson gson = new Gson();
            Type listType = new TypeToken<ArrayList<Estacionamento>>() {}.getType();
            estacionamentoList = gson.fromJson(jsonText,listType);
        } catch (Exception e) {
            e.printStackTrace();
        }

        localResult.setOnPostFlag(LocalResult.ESTACIONAMENTO);
        localResult.setEstacionamentos(estacionamentoList);
